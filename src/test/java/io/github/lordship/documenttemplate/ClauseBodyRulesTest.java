 ...
 *
 * <p>These lived inside {@code DocumentTemplateService} until a park could
 * write clause bodies too. The point of the tests is that one set of rules
 * governs both tables -- a park writing lease wording is writing lease wording.
 */
